...
public class NetworkManager : MonoBehaviourPunCallbacks
{
    ...
    void Start()
    {
        ...
        PhotonNetwork.AutomaticallySyncScene = true;   //this statement will syn all the scenes for the all the players in the room   
    ...
    public void OnCreateRoomButtonClicked()
    {
        ...
        if(GameMode!=null)
        {
            ...
            ExitGames.Client.Photon.Hashtable customRoomProperties = new ExitGames.Client.Photon.Hashtable() { { "gm", GameMode } };    //set value of gm key to GameMode string
    ...
    {
        Debug.Log(message);
        //if there exists no room then create one
        if (GameMode != null)
        {
            string roomName = RoomNameInputField.text;
